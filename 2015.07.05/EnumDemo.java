...
public class EnumDemo {
	...
	public void show() {
		...
		switch(mSample) {
			case ONE__FEN:
			case FIVE_FEN:	System.out.println("Less than 1 \"mao\".");
							break;
			case TEN__FEN:
			case FIFTY_FEN:	System.out.println("Less than 1 yuan.");
							break;
			case ONE_YUAN:
			case FIVE_YUAN: System.out.println("We offen use them.");
							break;
			case TEN_YUAN:
			case TWENTY_YUAN:	System.out.println("We can use them to have a lunch.");
								break;
		}
	}
}
