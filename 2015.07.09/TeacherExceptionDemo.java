...
class Computer{
	...
	public void runPC() throws BlueScreenException, SmokingException{
		switch(status){
			case NORMAL:		System.out.println("Computer is normally running...");
							break;
			case BLUE_SCREEN:	throw new BlueScreenException("The Laptop become blue-screen!!!");
			case SMOKING:		throw new SmokingException("The laptop is inflame and smoking!!!");
		}
	}
}
